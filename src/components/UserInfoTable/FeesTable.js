...
export default function FeesTable() {
    ...
    return ( <
            ...
            div style = {
                ...
                dataSource.map(({ mint, balance, pubkey, feeTier }, index) => ( <
                    ...
                    style = {
                        ...
                        'SRM' : mint.equals(TokenInstructions.MSRM_MINT) ?
                            'MSRM' : 'UNKNOWN'
                    } <
                    /Col> < /
                    Row >
        ...
        /div> { / * < DataTable * / } { / * dataSource = { dataSource } * / } { / * columns = { columns } * / } { / * pagination = { true } * / } { / * pageSize = { 5 } * / } { / * emptyLabel = "No (M)SRM accounts" * / } { / * />*/
} <
/Col> < /
Row > { /*<Row style={{ marginTop: 8 }}>*/ } { /*  <Col>*/ } { /*    <Typography>*/ } { /*      Holding SRM or MSRM makes you eligible for fee discounts:*/ } { /*    </Typography>*/ } { /*    <FeeScheduleTable />*/ } { /*  </Col>*/ } { /*</Row>*/ } <
    />
);
}