...
const MENU = [
   {
    'title': 'Trading',
    'link': 'https://swap.fyfy.app/dex/',
  },
  {
    'title': 'Swap',
    'link': 'https://swap.fyfy.app/swap/',
  },
  {
    'title': 'Liquidity',
    'child': [
      {
        'title': 'Pools',
        'link': 'https://swap.fyfy.app/pools/',
      },
      {
        'title': 'Add Liquidity',
        'link': 'https://swap.fyfy.app/liquidity/',
      },
    ]
  },
  // {
  ...
  //     {
  //       'title': 'Browse NFTs',
  //       'link': 'https://nft.fyfy.io/marketplace'
  //     },
  //     {
  //       'title': 'Explore Collections',
  //       'link': 'https://nft.fyfy.io/collections'
  //     },
  //   ]
  // }  
]
