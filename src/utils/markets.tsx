...
const _MARKETS = [
  ...
  },
  {
    ...
    programId: new PublicKey('vkG3Qrz6vCWjzDt5yCLEKYMYZ8hFZ27dmKe92btaZE3'),
  }
  // ...MARKETS,
];
...
export function MarketProvider({ marketAddress, setMarketAddress, children }) {
  ...
  const [marketName, setMarketName] = useState('FYFY/USDC');
    ...
    if (marketInfo) {
      if (marketInfo.deprecated) {
        ...
        if (DEFAULT_MARKET) {
          ...
          // setMarketAddress('vkG3Qrz6vCWjzDt5yCLEKYMYZ8hFZ27dmKe92btaZE3');
        }
      }
    }
